...
function Dashboardpage() {
  return (
    <div>
      <div className="py-10 w-full bg-white rounded-4xl">
        <div className="px-10 mb-12">
          <h2 className="font-bold text-3xl text-blue-900">Dashboard</h2>
        </div>
        <div className="w-full grid grid-cols-3 gap-2 rounded-lg px-8">
          <div className="bg-gray-50 py-5 px-6 space-y-8 rounded-lg">
            <div className="space-y-3">
              <p className="text-zinc-900 font-light text-xs">Total Proyek</p>
              <h3 className="text-zinc-900 text-2xl font-bold">12</h3>
            </div>
            <div className="space-y-3">
